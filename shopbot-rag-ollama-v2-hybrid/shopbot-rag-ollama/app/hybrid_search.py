"""
hybrid_search.py — Fusione RRF tra retrieval denso (ChromaDB) e sparso (BM25)
Implementa Reciprocal Rank Fusion: combina due ranking diversi usando
solo le posizioni, non i punteggi assoluti (che sono su scale incompatibili).
